function default_settings()
    Dict{Any, Any}("PrintModel" => 0, ##Documented
        "OverwriteResults" => 0,
        "NetworkExpansion" => 0, ##Documented
        "Trans_Loss_Segments" => 1, ##Documented
        "OperationalReserves" => 0, ##Documented
        "EnergyShareRequirement" => 0, ##Documented
        "CapacityReserveMargin" => 0, ##Documented
        "CO2Cap" => 0, ##Documented
        "StorageLosses" => 1, ##Documented
        "VirtualChargeDischargeCost" => 1,  # $/MWh ##Documented
        "MinCapReq" => 0, ##Documented
        "MaxCapReq" => 0, ##Documented
        "ParameterScale" => 0, ##Documented
        "WriteShadowPrices" => 0, ##Documented
        "UCommit" => 0, ##Documented
        "TimeDomainReduction" => 0, ##Documented
        "TimeDomainReductionFolder" => "TDR_results", ##Documented
        "ModelingToGenerateAlternatives" => 0, ##Documented
        "ModelingtoGenerateAlternativeSlack" => 0.1, ##Documented
        "MGAAnnualGeneration" => 0,
        "MultiStage" => 0, ##Documented
        "MethodofMorris" => 0, ##Documented
        "IncludeLossesInESR" => 0,
        "EnableJuMPStringNames" => false,
        "HydrogenHourlyMatching" => 0,
        "DC_OPF" => 0,
        "WriteOutputs" => "full", ##Documented
        "ComputeConflicts" => 0,
